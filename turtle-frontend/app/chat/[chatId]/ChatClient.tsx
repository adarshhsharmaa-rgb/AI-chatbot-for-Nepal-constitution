...
import { Message, Project } from "@/app/hooks/types";
import ThemeToggle from "@/app/components/ThemeToggle";
import { useRouter } from "next/navigation";

const BACKEND_URL =
  "https://ai-chatbot-for-nepal-constitution-production.up.railway.app";
    ...
    <div className="flex h-screen bg-[#F8FAFC] dark:bg-gray-900 transition-colors duration-200">
      ...
      >
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <button
            className="flex items-center justify-start space-x-2 px-4 py-2 mt-6 bg-primary text-white rounded-xl hover:bg-primary-dark transition-colors"
                    ...
                    <button
                      onClick={async () => {
                        ...
                        const prompts = await axios.get(
                          `${BACKEND_URL}/project/${project.id}`,
                          {
                            headers: {
                              Authorization: `Bearer ${token}`,
                            },
                        ...
                        setMessages(prompts.data as Message[]);
                      }}
                    >
                      <span className="text-sm text-gray-700 dark:text-gray-300">
                        {project.description || "New Chat"}
                      </span>
                    </button>
                  </div>
                </div>
              ...
              <div>
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm mb-4">
                  <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3">
                    Welcome to Turtle Justice
                  </h2>

                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    I&apos;m your AI legal assistant, ready to help you navigate
                    Nepal&apos;s legal system. How can I assist you today?
                  </p>

                  <div className="flex flex-wrap gap-2">
                    <button
                      className="px-4 py-2 bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
                      onClick={() =>
            ...
            <div className="relative">
              ...
              <button
                onClick={async () => {
                  ...
                  if (showFirstTime) {
                    await axios.post(
                      `${BACKEND_URL}/generateUsefulName/${projectId}`,
                      {
                        query: message,
                      },
                      {
